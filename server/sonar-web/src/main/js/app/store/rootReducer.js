...
import issueFilters, * as fromIssueFilters from './issueFilters/reducer';
import measures, * as fromMeasures from './measures/reducer';

import issuesActivity, * as fromIssuesActivity from '../../apps/myActivity/store/reducer';

export default combineReducers({ users, favorites, issuesActivity, issueFilters, measures });
...
export const getBacklog = state => (
    fromIssuesActivity.getBacklog(state.issuesActivity)
);

export const getFavoriteIssueFilters = state => (
    fromIssueFilters.getFavoriteIssueFilters(state.issueFilters)
);
