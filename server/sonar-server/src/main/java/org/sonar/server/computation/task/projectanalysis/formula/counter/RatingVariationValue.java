...
/**
 * Convenience class wrapping a rating to compute the value of a MeasureVariation as a rating and know it is has ever been
 * set.
 * <p>
  ...
  public static class Array {
    ...
    */
    ...
    private boolean isAnySet() {
      for (RatingVariationValue variationValue : values) {
